...
VALUES
('Mega Burguer Clasica', 'Pan brioche tostado, doble carne 100% vacuno, queso cheddar derretido, lechuga fresca, tomate y salsa especial Mega.', 'Hamburguesa clasica premium con doble carne jugosa y sabor intenso.', 9990, 'https://images.pexels.com/photos/2271107/pexels-photo-2271107.jpeg', 'Burguers', true, false, 20),
...
('Combo Doble Queso', 'Doble carne con doble queso cheddar, papas medianas y bebida.', 'Explosion de queso y carne en un combo irresistible.', 10990, 'https://images.pexels.com/photos/5908286/pexels-photo-5908286.jpeg', 'Combos', false, true, 10),
...
('Combo Familiar Mega', '4 hamburguesas clasicas, 2 porciones grandes de papas y 4 bebidas.', 'Combo ideal para compartir en familia.', 24990, 'https://images.pexels.com/photos/4021939/pexels-photo-4021939.jpeg', 'Combos', false, true, 5),
...
('Triple Mega Burguer', 'Hamburguesa triple carne con triple queso y salsa especial.', 'Maximo nivel: triple carne y triple queso.', 11990, 'https://media.istockphoto.com/id/1453739155/es/foto/toma-vertical-de-una-deliciosa-hamburguesa-jugosa-con-triple-hamburguesa-sobre-una-mesa-de.jpg?b=1&s=612x612&w=0&k=20&c=2CYj870Znz_Lqv2zIbrHBArxV6RnKNxdAwAKdirGui4=', 'Burguers', false, false, 15),
('Veggie Burguer', 'Hamburguesa vegetariana con medallon vegetal, palta y vegetales frescos.', 'Opcion vegetariana fresca y balanceada.', 8990, 'https://images.unsplash.com/photo-1520072959219-c595dc870360', 'Burguers', false, false, 12),
('Papas Fritas Clasicas', 'Papas fritas crujientes recien hechas.', 'Clasicas papas doradas y crujientes.', 2990, 'https://images.pexels.com/photos/1583884/pexels-photo-1583884.jpeg', 'Fries', false, false, 40),
...
('Coca-Cola 350ml', 'Bebida Coca Cola clasica 350ml.', 'Refresco clasico ideal para acompañar.', 1990, 'https://media.istockphoto.com/id/1062831310/es/foto/vierta-el-refresco-en-vaso-con-poco-de-hielo-sobre-fondo-oscuro.jpg?b=1&s=612x612&w=0&k=20&c=h1ntgfXP_ABi2H945DfU8c-di1f1wj12LPrnPPojFTE=', 'Drinks', false, false, 50),
('Sprite 350ml', 'Bebida Sprite refrescante 350ml.', 'Refresco sabor limon ligero.', 1990, 'https://images.unsplash.com/photo-1592860893757-84536a1c9b82?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c3ByaXRlfGVufDB8fDB8fHww', 'Drinks', false, false, 50),
